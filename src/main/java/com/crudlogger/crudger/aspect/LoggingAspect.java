...
import com.crudlogger.crudger.aspect.logger.model.json.ActionStatusEnum;
import com.crudlogger.crudger.aspect.logger.model.json.Params;
import com.crudlogger.crudger.aspect.logger.model.json.RequestDataChange;
import com.crudlogger.crudger.aspect.logger.model.json.ResponseDataAfterChange;
import com.crudlogger.crudger.aspect.logger.service.LogEntityService;
import com.crudlogger.crudger.crud.controller.advice.PointcutException;
...
//    private UserService userService;
    ...
    @Pointcut("@annotation(com.crudlogger.crudger.aspect.ToLogger)")
    public void callLogger() {
    }

    @Before("@annotation(com.crudlogger.crudger.aspect.ToLogger)")
    ...
    @AfterReturning(value = "@annotation(com.crudlogger.crudger.aspect.ToLogger)", returning = "returnValue")
    ...
    @AfterThrowing(value = "@annotation(com.crudlogger.crudger.aspect.ToLogger)", throwing = "exception")
