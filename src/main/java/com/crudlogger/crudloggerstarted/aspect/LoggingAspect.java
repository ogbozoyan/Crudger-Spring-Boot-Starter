package com.crudlogger.crudloggerstarted.aspect;

import com.crudlogger.crudloggerstarted.aspect.logger.model.LogEntity;
import com.crudlogger.crudloggerstarted.aspect.logger.model.json.ActionStatusEnum;
import com.crudlogger.crudloggerstarted.aspect.logger.model.json.Params;
import com.crudlogger.crudloggerstarted.aspect.logger.model.json.RequestDataChange;
import com.crudlogger.crudloggerstarted.aspect.logger.model.json.ResponseDataAfterChange;
import com.crudlogger.crudloggerstarted.aspect.logger.service.LogEntityService;
import com.crudlogger.crudloggerstarted.crud.controller.advice.PointcutException;
...
//    private UserService userService;
    ...
    @Pointcut("@annotation(com.crudlogger.crudloggerstarted.aspect.ToLogger)")
    public void callLogger() {
    }

    @Before("@annotation(com.crudlogger.crudloggerstarted.aspect.ToLogger)")
    ...
    @AfterReturning(value = "@annotation(com.crudlogger.crudloggerstarted.aspect.ToLogger)", returning = "returnValue")
...
//        logger.info(objectWriter.writeValueAsString(logEntity).replaceAll("[\n\r\t]", ""));
    ...
    @AfterThrowing(value = "@annotation(com.crudlogger.crudloggerstarted.aspect.ToLogger)", throwing = "exception")
